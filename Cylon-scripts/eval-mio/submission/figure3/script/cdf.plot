...
#mean_nolinear = real(system("./calc_mean.sh ../dat/nolinear/N0m1_t8_b8192.dat"))
...
#set arrow 1 from mean_nolinear,0 to mean_nolinear,1 nohead lc rgb "#1f77b4" lw 5 dt 2 front
...
#set label 1 sprintf("Avg: %.0f", mean_nolinear) at mean_nolinear,0.5 left offset 0.5,0 font ",16" tc rgb "#1f77b4"
